...
def test_app_settings_env_vars(monkeypatch):
    ...
    monkeypatch.setenv("POSTGRES_CONNECTION_STRING", "postgresql://test:test@localhost:5432/testdb")
    ...
    # Note: The actual value may be different due to environment variables
    assert "postgresql://test:test@localhost:5432/testdb" in settings.postgres_connection_string
